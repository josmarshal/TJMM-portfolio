// Thomas Marshal Portfolio ÔÇö App JS
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    externalLinks.forEach(link => {
        ...
        if (!href || href === '#' || href === '') {
            console.warn('ÔÜá´©Å Empty or broken external link detected:', link);
            link.style.opacity = '0.5';
            link.title = 'Link unavailable';
        }
    });

    console.log(`Ô£à Thomas Marshal Portfolio loaded. ${externalLinks.length} external links found.`);
});
